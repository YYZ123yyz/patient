...
public class SimpleDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    //第一行是否显示
    private boolean isFirstDriverVisible;
    public SimpleDividerItemDecoration(Context context, int orientation,boolean isFirstDriverVisible) {
        TypedArray a = context.obtainStyledAttributes(ATTRS);
        this.mDivider = a.getDrawable(0);
        this.isFirstDriverVisible=isFirstDriverVisible;
