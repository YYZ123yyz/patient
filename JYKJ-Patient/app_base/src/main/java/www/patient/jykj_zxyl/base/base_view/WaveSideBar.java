...
/**
 * Created by G on 2020/10/8 18:57
 */
public class WaveSideBar extends View {
    private final static int DEFAULT_TEXT_SIZE = 10; // sp
    private final static int DEFAULT_MAX_OFFSET = 40; //dp
...
//            mPaint.setTextSize(mTextSize + mTextSize*scale);
            int color = (i == mCurrentIndex) ? Color.parseColor("#1786F8") : Color.parseColor("#000000");
            ...
            canvas.drawText(
                    ...
                    getWidth() - getPaddingRight(), //baseLine X
