...
import com.hyphenate.easeui.widget.chatrow.EaseChatRoomRowText;
...
public class EaseChatRoomTextPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatRoomTextPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRoomRowText(cxt, message, position, adapter);
    }
