 ...
 */
public class RefusedCancelContract {
    ...
    public interface View extends BaseView {
         ...
         * @param msg 拒绝订单返回信息
         */
        void getRefusedCancelResult(boolean isSucess, String msg);
    ...
    public interface Presenter extends BasePresenter<View> {
         ...
         */
        void sendRefusedCancelContractRequest(String loginDoctorPosition,
