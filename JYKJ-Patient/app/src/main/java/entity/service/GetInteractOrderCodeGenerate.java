...
public class GetInteractOrderCodeGenerate {
    ...
    public String getOrderTreatmentType() {
        return orderTreatmentType;
    }

    public void setOrderTreatmentType(String orderTreatmentType) {
        this.orderTreatmentType = orderTreatmentType;
    }
}
