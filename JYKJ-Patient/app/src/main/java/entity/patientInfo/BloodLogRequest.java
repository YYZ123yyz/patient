...
public class BloodLogRequest {
    ...
    public String getSearchRecordDate() {
        return searchRecordDate;
    }

    public void setSearchRecordDate(String searchRecordDate) {
        this.searchRecordDate = searchRecordDate;
    }
