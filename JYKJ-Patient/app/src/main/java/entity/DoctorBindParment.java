...
public class DoctorBindParment {
    ...
    public String getOperPatientLinkPhone() {
        return operPatientLinkPhone;
    }

    public void setOperPatientLinkPhone(String operPatientLinkPhone) {
        this.operPatientLinkPhone = operPatientLinkPhone;
    }
    ...
    public String getBindingApplyInfo() {
        return bindingApplyInfo;
    }

    public void setBindingApplyInfo(String bindingApplyInfo) {
        this.bindingApplyInfo = bindingApplyInfo;
    }
}
