...
import orcameralib.util.DimensionUtil;
import orcameralib.util.ImageUtil;
    ...
    public void setMaskType(@MaskView.MaskType int maskType) {
        ...
        switch (maskType) {
            case MaskView.MASK_TYPE_ID_CARD_FRONT:
                hintResourceId = R.mipmap.bd_ocr_hint_align_id_card;
                break;
            case MaskView.MASK_TYPE_ID_CARD_BACK:
                hintResourceId = R.mipmap.bd_ocr_hint_align_id_card_back;
                break;
