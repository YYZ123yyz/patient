        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //压缩图片
                    bitmap = www.patient.jykj_zxyl.util.BitmapUtil.getimageBitmap(bitmap);
                    mApp.gBitMapString = BitmapUtil.bitmaptoString(bitmap);
                ...
                intent.putExtra("outputString",outputFile.toString());
