...
import www.patient.jykj_zxyl.activity.home.tjhz.IDCardScanningActivity;
import www.patient.jykj_zxyl.activity.home.tjhz.IDCardScanningActivity;
...
//        mCamera.takePicture(null, null, jpeg);
    ...
    private Camera.PictureCallback jpeg = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera Camera) {
            ...
            try {
                //byte[] 转 base64
//                String imgBase64 = BitmapUtil.byteToString(data);
                //将获取到的图片信息回传到activity
                mActivity.setIDCardDate(data);
...
//                    mCamera.startPreview();// 开启预览
    ...
    public void takePicture(Activity activity){
        mActivity = (IDCardScanningActivity) activity;
        //设置参数,并拍照
        setCameraParams(mCamera, mScreenWidth, mScreenHeight);
