 ...
 * 用户协议
 */
public class YHXYWebActivity extends AppCompatActivity {

    private                 Context                     mContext;
    private YHXYWebActivity mActivity;
    ...
    private void initLayout() {
        ...
        webView.loadUrl("https://jiuyihtn.com/AppAssembly/userAgreement.html");
