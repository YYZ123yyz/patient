 ...
 *  就医总览
 */
public class JYZLecycleAdapter extends RecyclerView.Adapter<JYZLecycleAdapter.ViewHolder> {
    ...
    public JYZLecycleAdapter(List<HZIfno> list, Context context){
        mContext = context;
        datas = list;
    }
    ...
    public void setDate(List<HZIfno> list){
       ...
       @Override
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType){
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_activityjyzl,viewGroup,false);
