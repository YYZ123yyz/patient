...
public class WithoutUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View view=inflater.inflate(R.layout.fragment_withoutuser,container,false);
        mContext = getContext();
        mActivity = (MyCouponDetailActivity) getActivity();
        mCouponDetailRecycleView = (RecyclerView) view.findViewById(R.id.rv_fragmentWithoutUse_couponInfo);
    ...
    private void setData() {
        for (int i = 0; i < 20; i++)
        {
          ...
          myCouponDetailEntity.setState(1);
