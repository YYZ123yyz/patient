 ...
 */
public class Home_AudioAdapter extends RecyclerView.Adapter<Home_AudioAdapter.ViewHolder> {

    private List<CancelContractBean> datas;
    private Context mContext;
    private OnItemClickListener mOnItemClickListener;
    public Home_AudioAdapter(List<CancelContractBean> datas, Context mContext) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_audio,
                parent, false);
