                ...
                switch (msg.what) {
                    case 0:
                        ...
                        if (netRetEntity.getResCode() == 0)
                        {
                            ...
                            Toast.makeText(SurplusDetailTJActivity.this,netRetEntity.getResMsg(),Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
...
//
    ...
    private PieData setPieData(List<PieEntry> pieEntryList){
        ...
        colors.add(Color.parseColor("#4CAAA4"));
        colors.add(Color.parseColor("#CD8658"));
        colors.add(Color.parseColor("#C65162"));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_start_time:
                startTime = new TimePickerBuilder(SurplusDetailTJActivity.this, new OnTimeSelectListener() {
                    @Override
            ...
            case R.id.tv_end_time:
                endTime = new TimePickerBuilder(SurplusDetailTJActivity.this, new OnTimeSelectListener() {
                    @Override
                    public void onTimeSelect(Date date, View v) {
            ...
            case R.id.tv_view_time:
                optionPick = new OptionsPickerBuilder(SurplusDetailTJActivity.this, new OnOptionsSelectListener() {
                    @Override
