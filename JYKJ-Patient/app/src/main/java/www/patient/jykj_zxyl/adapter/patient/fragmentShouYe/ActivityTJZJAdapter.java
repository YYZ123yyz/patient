 ...
 * 首页==》推荐专家
 */
public class ActivityTJZJAdapter extends RecyclerView.Adapter<ActivityTJZJAdapter.ViewHolder> {
    ...
    public ActivityTJZJAdapter(List<ProvideViewDoctorExpertRecommend> list, Context context){
        mContext = context;
        datas = list;
    }
