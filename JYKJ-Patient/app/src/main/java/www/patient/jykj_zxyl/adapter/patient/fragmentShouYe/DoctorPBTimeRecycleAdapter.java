 ...
 * 医生排班 == >时间段
 */
public class DoctorPBTimeRecycleAdapter extends RecyclerView.Adapter<DoctorPBTimeRecycleAdapter.ViewHolder> {
    public          List<ProvideDoctorSetSchedulingInfoGroupTime>            datas = new ArrayList<>();
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
            ...
            viewHolder.mDate.setText(datas.get(position).getDayTimeSlot());
