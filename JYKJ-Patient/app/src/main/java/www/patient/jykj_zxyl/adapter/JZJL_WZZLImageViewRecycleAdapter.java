...
public class JZJL_WZZLImageViewRecycleAdapter extends RecyclerView.Adapter<JZJL_WZZLImageViewRecycleAdapter.ViewHolder> {
    ...
    private Context mContext;
        ...
        public JZJL_WZZLImageViewRecycleAdapter(List<ProvideBasicsImg> list, Context context){
            datas = list;
            mContext = context;
        }
