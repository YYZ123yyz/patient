 ...
 * 首页订单消息
 */
public class YHHDOrderMesageRecycleAdapter extends RecyclerView.Adapter<YHHDOrderMesageRecycleAdapter.ViewHolder> {
    ...
    public YHHDOrderMesageRecycleAdapter(List<HZIfno> list, Context context, MyOrderActivity mainActivity){
        mContext = context;
        datas = list;
