...
public class PermissionUtils {
    ...
    public static final int CODE_RSMS = 10;
    public static final int CODE_BSMS = 11;
    public static final int CODE_RESMS = 12;
    public static final int CODE_WAKELOCK = 13;
    public static final int CODE_INTENET = 14;
    public static final int CODE_MOUNT_UNMOUNT_FILESYSTEMS = 15;
    public static final int ACCESS_NETWORK_STATE = 16;
    public static final int READ_CONTACT = 17;
    ...
    public static final String RSMS = Manifest.permission.RECEIVE_SMS;
    public static final String BSMS = Manifest.permission.BROADCAST_SMS;
    public static final String RESMS = Manifest.permission.READ_SMS;
    public static final String WAKE_LOCK = Manifest.permission.WAKE_LOCK;
    public static final String PERMISSION_INTENET = Manifest.permission.INTERNET;
    public static final String PERMISSION_MOUNT_UNMOUNT_FILESYSTEMS = Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS;
    public static final String NETWORKSTATE = Manifest.permission.ACCESS_NETWORK_STATE;
...
//        }
        ...
        try {
            //检查是否有此权限，如果已经开启，则直接做想做的事，如果未开启，则判断是否需要向用户解释为何申请权限
