...
import www.patient.jykj_zxyl.adapter.MyApplyAdapter;
...
public class FragmentMyApply extends Fragment {
    ...
    private void initView(View v){
        ...
        mAdapter = new MyApplyAdapter(mMyApplyInfoList,mContext,mApp);
        ...
        new Thread(){
            public void run(){
                try {
                    ...
                    //获取医院数据
                    mNetRetStr = HttpNetService.urlConnectionService("jsonDataInfo="+str,Constant.SERVICEURL+"/unionDoctorController/searchApplyDoctorUnionByParam");
