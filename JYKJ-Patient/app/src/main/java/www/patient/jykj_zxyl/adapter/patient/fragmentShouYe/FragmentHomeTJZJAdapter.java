 ...
 * 首页==》推荐专家
 */
public class FragmentHomeTJZJAdapter extends RecyclerView.Adapter<FragmentHomeTJZJAdapter.ViewHolder> {
    ...
    public FragmentHomeTJZJAdapter(List<ProvideViewDoctorExpertRecommend> list, Context context){
        mContext = context;
        datas = list;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        Log.i("价格",datas.get(position).getImgTextPriceShow());
        Log.i("价格",datas.get(position).getPhonePriceShow());
        Log.i("价格",datas.get(position).getAudioPriceShow());
        Log.i("价格",datas.get(position).getVideoPriceShow());
        Log.i("价格",datas.get(position).getSigningPriceShow());
        ...
        if (datas.get(position).getPhoneSumNum() == null  || "".equals(datas.get(position).getPhoneSumNum()))
            viewHolder.phoneSumNum.setText("未设置");
        else
            viewHolder.phoneSumNum.setText(datas.get(position).getPhoneSumNum()+"人咨询");
