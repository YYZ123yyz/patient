...
public class TWJZ_ZDMSActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        provideInteractOrderDiag.setOperDoctorCode(mApp.mProvideViewSysUserPatientInfoAndRegion.getPatientCode());
        provideInteractOrderDiag.setOperDoctorName(mApp.mProvideViewSysUserPatientInfoAndRegion.getPatientCode());
    ...
    private void showLayoutDate() {
        ...
        mTitleName.setText("【"+mProvideInteractOrderDiag.getPatientName()+"】诊断描述");
