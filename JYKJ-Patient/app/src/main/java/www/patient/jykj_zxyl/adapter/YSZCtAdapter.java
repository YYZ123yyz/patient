 ...
 * 推荐专家==>医生职称Adapter
 */
public class YSZCtAdapter extends RecyclerView.Adapter<YSZCtAdapter.ViewHolder> {

    private List<ProvideBasicsDomain> mDate;
    private Context mContext;
    private TJZJActivity mActivity;
    public YSZCtAdapter(List<ProvideBasicsDomain> date, Context context,TJZJActivity activity){
        mDate = date;
        mContext = context;
        mActivity = activity;
    }
