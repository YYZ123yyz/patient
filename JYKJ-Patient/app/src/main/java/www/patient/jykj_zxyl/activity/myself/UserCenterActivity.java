            ...
            public void run() {
                ...
                try {
                    ...
                    if (netRetEntity.getResCode() == 1) {
                        ...
                        mApp.mProvideViewSysUserPatientInfoAndRegion.setLinkPhone(StrUtils.defaultStr(mProvideViewSysUserPatientInfoAndRegion.getLinkPhone()));
                        Log.e("tag", "手机号 " + mApp.mProvideViewSysUserPatientInfoAndRegion.getLinkPhone());
