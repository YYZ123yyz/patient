 ...
 * 联盟信息，我的邀请
 */
public class UnionMyInvateAdapter extends RecyclerView.Adapter<UnionMyInvateAdapter.ViewHolder>{

    private List<ProvideViewUnionDoctorMemberInviteInfo> mDate;
    private Context                                     mContext;
    private JYKJApplication                             mApp;

    public UnionMyInvateAdapter(List<ProvideViewUnionDoctorMemberInviteInfo> list, Context context, JYKJApplication app){
        mDate = list;
        mContext = context;
        mApp = app;
    }
