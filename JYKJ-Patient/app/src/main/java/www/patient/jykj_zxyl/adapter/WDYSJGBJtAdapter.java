 ...
 * 我的医生机构背景Adapter
 */
public class WDYSJGBJtAdapter extends RecyclerView.Adapter<WDYSJGBJtAdapter.ViewHolder> {

    private List<ProvideBasicsDomain>   mDate;
    private Context                     mContext;
    private WDYSActivity mActivity;
    public WDYSJGBJtAdapter(List<ProvideBasicsDomain> date, Context context, WDYSActivity activity){
        mDate = date;
        mContext = context;
        mActivity = activity;
    }
