 ...
 */
public class CommonMutipleGoOrderListItemType implements IMulItemViewType<MultiItemEntity> {
    ...
    public int getItemViewType(int i, MultiItemEntity multiItemEntity) {
        ...
        switch (itemType){
            case MULTIPLE_CONTENT_ORDINARY_TYPE:
                return 1;
            case MULTIPLE_CONTENT_SIGN_UP_TYPE:
                return 2;
            default:
                return -1;
        }
