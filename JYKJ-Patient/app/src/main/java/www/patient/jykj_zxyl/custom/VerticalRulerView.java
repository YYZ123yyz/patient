...
public class VerticalRulerView extends View{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.textColor_hzgltabtx));
        centerLinePaint.setStrokeWidth(3);

        grayLinePaint = new Paint();
        grayLinePaint.setAntiAlias(true);
        grayLinePaint.setColor(getResources().getColor(R.color.hintTextColor));
        grayLinePaint.setStrokeWidth(3);

        txtPaint = new Paint();
        txtPaint.setAntiAlias(true);
        txtPaint.setColor(getResources().getColor(R.color.hintTextColor));
