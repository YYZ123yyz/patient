...
//        getDate();
    ...
    private void initView(View v){
        ...
        mAdapter = new UnionMyBeInvateAdapter(mProvideViewUnionDoctorMemberInviteInfo,mContext,mApp);
        ...
        mAdapter.setOnItemClickListener(new UnionMyBeInvateAdapter.OnItemClickListener() {
            @Override
            public void onClick(int position) {
                startActivity(new Intent(mContext,UnionInvateHandlerActivity.class).putExtra("invateInfo", mProvideViewUnionDoctorMemberInviteInfo.get(position)));
            }
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    mNetRetStr = HttpNetService.urlConnectionService("jsonDataInfo=" + jsonString, Constant.SERVICEURL + "unionDoctorController/searchInviteDoctorUnionApproval");
