...
public class INetAddress {
    ...
    public static String QUERY_PASTHIST_URL = "patientHealthRecordsControlle/searchPatientConditionDiseaseRecordList_V200916";//获取既往病史
    public static String QUERY_PERSON_PASTHIST_URL = "patientHealthRecordsControlle/searchPatientConditionDiseaseRecordResData_V200916";//本人填写既往病史详情
    ...
    public static String SUB_PATIENTHISTIMG_URL = "patientHealthRecordsControlle/operUpdPatientConditionDiseaseRecordAndImg";//既往病史上传图片
    ...
    public static String QUERY_JWBS_YSTX_DETAIL = "patientHealthRecordsControlle/searchPatientConditionDiseaseRecordResDoctorData_V200916";//既往病史详情[医生填写]
