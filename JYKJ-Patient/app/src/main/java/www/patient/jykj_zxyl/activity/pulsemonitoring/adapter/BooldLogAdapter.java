 ...
 * 血压异常记录
 */
public class BooldLogAdapter extends RecyclerView.Adapter<BooldLogAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_booldlog_detail, parent, false);
