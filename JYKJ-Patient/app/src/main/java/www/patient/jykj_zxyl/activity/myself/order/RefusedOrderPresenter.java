 ...
 */
public class RefusedOrderPresenter extends BasePresenterImpl<RefusedOrderContract.View>
        implements RefusedOrderContract.Presenter {
    ...
    @Override
    public void sendRefusedOrderRequest(String loginDoctorPosition, String mainDoctorCode,
                                        String mainDoctorName, String signCode, String signNo,
                                        String mainPatientCode, String mainUserName, String confimresult,
                                        String refuseReasonClassCode, String refuseReasonClassName,
                                        String refuseRemark) {
        HashMap<String, Object> hashMap = ParameUtil.buildBaseParam();
                ...
                if (mView!=null) {
                    ...
                    protected void onSuccessResult(BaseBean baseBean) {
                        if (mView!=null) {
                            ...
                            if (resCode == 1) {
                            mView.getRefusedOrderResult(true,"");
                            }else{
                                mView.getRefusedOrderResult(false,baseBean.getResMsg());
                            }
                        }
                    }
    ...
    @Override
    public void sendSearchSignPatientDoctorOrderRequest(String signCode, Activity activity) {
        ...
        ApiHelper.getApiService().getUserInfoList(s).
            ...
            protected void onSuccessResult(BaseBean baseBean) {
                if (mView!=null) {
                    ...
                    if (resCode==1) {
                        String resJsonData = baseBean.getResJsonData();
                        UserInfoBaseBean userInfoBaseBean = GsonUtils.fromJson(resJsonData, UserInfoBaseBean.class);
                        mView.getUserInfoResult(userInfoBaseBean);
                    }
                }
