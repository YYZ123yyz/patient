...
public class ZHLYImageViewRecycleAdapter extends RecyclerView.Adapter<ZHLYImageViewRecycleAdapter.ViewHolder> {
    ...
    private Context mContext;
        ...
        public ZHLYImageViewRecycleAdapter(List<ProvideBasicsImg> list, Context context){
            datas = list;
            mContext = context;
        }
