package util.com.example.lenovo.drawerlibrary;
...
public class ButtomDrawerLayout extends ViewGroup {
    ...
    public ButtomDrawerLayout(Context context) {
        super(context);
        init(context);
    }

    public ButtomDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ButtomDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class DragerCallBack extends  ViewDragHelper.Callback{
        ...
        public int getOrderedChildIndex(int index) {
            int childCount = ButtomDrawerLayout.this.getChildCount();
